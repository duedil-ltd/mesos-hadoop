...
To run _Hadoop on Mesos_ you need to add the `hadoop-mesos-0.2.0.jar`
...
You can build `hadoop-mesos-0.2.0.jar` using Maven:

```shell
mvn package
```

If successful, the JAR will be at `target/hadoop-mesos-0.2.0.jar`.
